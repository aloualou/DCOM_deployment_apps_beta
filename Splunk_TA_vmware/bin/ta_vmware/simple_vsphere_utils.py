	...
	def _login(self, username, password):
		...
		request_body = """<?xml version="1.0" encoding="UTF-8"?>
			<SOAP-ENV:Envelope xmlns:ns0="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ns1="urn:vim25" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
			  ...
			  <ns0:Body>
				 <ns1:Login>
					<ns1:_this type="SessionManager">""" + self.session_manager_moid + """</ns1:_this>
	...
	def logout(self):
		...
		request_body = """<?xml version="1.0" encoding="UTF-8"?>
			<SOAP-ENV:Envelope xmlns:ns0="urn:vim25" xmlns:ns1="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
			   ...
			   <ns1:Body>
			      <ns0:Logout>
			         <ns0:_this type="SessionManager">""" + self.session_manager_moid + """</ns0:_this>
			      </ns0:Logout>
			   </ns1:Body>
			</SOAP-ENV:Envelope>
			"""
				...
				<SOAP-ENV:Envelope xmlns:ns0="urn:vim25" xmlns:ns1="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
				   ...
				   <ns1:Body>
				      <ns0:RetrieveProperties>
				         ...
				         <ns0:specSet>
				            <ns0:propSet>
				              <ns0:type>""" + obj_type + """</ns0:type>
				              <ns0:pathSet>""" + pathSet + """</ns0:pathSet>
				            </ns0:propSet>
				            <ns0:objectSet>
				                <ns0:obj type='""" + obj_type + """'>""" + host_moid + """</ns0:obj>
		...
		try:
			request_body = """<?xml version="1.0" encoding="UTF-8"?>
				<SOAP-ENV:Envelope xmlns:ns0="urn:vim25" xmlns:ns1="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
				   ...
				   <ns1:Body>
				      <ns0:QueryOptions>
				         <ns0:_this type="OptionManager">""" + config_manager_id + """</ns0:_this>
				         <ns0:name>""" + prop_name + """</ns0:name>
				      </ns0:QueryOptions>
				   </ns1:Body>
				</SOAP-ENV:Envelope>
				"""
						...
						<SOAP-ENV:Envelope xmlns:ns0="urn:vim25" xmlns:ns1="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
						   ...
						   <ns1:Body>
						      <ns0:UpdateOptions>
						         ...
						         <ns0:changedValue>
						            <ns0:key>""" + key + """</ns0:key>
						            <ns0:value xsi:type='""" + value_type + """'>""" + value + """</ns0:value>
						         </ns0:changedValue>
						      </ns0:UpdateOptions>
						   </ns1:Body>
						</SOAP-ENV:Envelope>
			...
			request_body = """<?xml version="1.0" encoding="UTF-8"?>
							   <SOAP-ENV:Envelope xmlns:ns0="urn:vim25" xmlns:ns1="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
							    <SOAP-ENV:Header/>
							     <ns1:Body>
							      <ns0:EnableRuleset>
							       <ns0:_this type='""" + obj_type + """'>""" + moid + """</ns0:_this>
							        <ns0:id>""" + id_name + """</ns0:id>
							      </ns0:EnableRuleset>
							     </ns1:Body>
							   </SOAP-ENV:Envelope>     
				"""
		...
		try:
			...
			for propName in propset:
				request_body = request_body + """
						<ns1:propSet>
			                <ns1:type>"""+propName.get('type', None)+"""</ns1:type>
			                <ns1:all>"""+str(propName.get('all', '')).lower()+"""</ns1:all>
			                <ns1:pathSet>"""+propName.get('pathSet', None)+"""</ns1:pathSet>
			            </ns1:propSet>"""
			# Add object set
			request_body = request_body + """
			            <ns1:objectSet>
			                <ns1:obj type='"""+rootInfo.get('type', None)+"""'>"""+rootInfo.get('moid', None)+"""</ns1:obj>
			                <ns1:skip>false</ns1:skip>
			                <ns1:selectSet xsi:type="ns1:TraversalSpec">
			                    <ns1:name>visitFolders</ns1:name>
			                    <ns1:type>Folder</ns1:type>
