...
class GenericParser(Parser):
    ...
    def __init__(self, fields, delim_regex=None, extract_regex=None, ignore_regex=None):
        ...
        try:
            self._delim_regex = re.compile(delim_regex) if delim_regex else None
            self._extract_regex = re.compile(extract_regex) if extract_regex else None
            self._ignore_regex = re.compile(ignore_regex) if ignore_regex else None
        except re.error:
            raise
