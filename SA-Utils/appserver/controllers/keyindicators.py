...
class KeyIndicators(controllers.BaseController):
    ...
    def highest_group_number(search):
        ...
        highest_group_number_this_far = -1
        ...
        for k, v in search.items():
            ...
            if m:
                ...
                if number > highest_group_number_this_far:
                    highest_group_number_this_far = number
            
        return highest_group_number_this_far
    ...
    def update_search(self, search, search_name, indicator, group_name, save=True):
        ...
        if existing_group_number is not None:
            ...
            group_number = KeyIndicators.highest_group_number(search)
