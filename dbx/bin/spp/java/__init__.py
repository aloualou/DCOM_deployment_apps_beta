...
logFilename = os.path.join(os.environ['SPLUNK_HOME'], 'var', 'log', 'splunk', DEFAULT_LOG_FILENAME)
logger = logging.getLogger("java")
logger.setLevel(DEFAULT_LOG_LEVEL)
handler = logging.handlers.RotatingFileHandler(filename=logFilename, mode='a', maxBytes=DEFAULT_MAX_LOGFILE_BYTES, backupCount=DEFAULT_MAX_LOGFILE_COUNT)
