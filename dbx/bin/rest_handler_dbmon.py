...
class DatabaseMonitorEntityEndpoint(EntityEndpoint):
    ...
    def _getConfigItems(self):
        ...
        thing = en.getEntities("configs/conf-inputs", sessionKey=self.getSessionKey(), namespace=namespace, owner="nobody",
    ...
    def writeConf(self, confName, stanzaName, settingsDict):
        namespace = self.namespace if hasattr(self, "namespace") else "dbx" 
        entity = en.Entity("configs/conf-inputs", stanzaName, namespace=namespace, owner="nobody")
