require(
		[
				...
				"/en-US/static/app/DCOM_S/components/memoryoverheadinfo/MemoryOverheadInfoView_home.js",
		...
		function($, _, mvc, SearchManager, MemoryOverheadInfo) { 
			...
			var setTokens = function(clusterData) {
				...
				if (cluster_id === null || cluster_id === undefined || clusterData[cluster_id] === undefined) {
					...
					submittedTokens.set("p_average_clusterServices_effectivemem_megaBytes", null)
					
					
				} else {
					submittedTokens.set("SafeEffMem_megaBytes", clusterData[cluster_id].SafeEffMem_megaBytes);
					submittedTokens.set("hostCount", clusterData[cluster_id].hostCount);
					...
					submittedTokens.set("p_average_clusterServices_effectivemem_megaBytes", clusterData[cluster_id].p_average_clusterServices_effectivemem_megaBytes);
			...
			var onHostsCountChange = function() {
				console.log("MEM.onHostsCountChange:");
