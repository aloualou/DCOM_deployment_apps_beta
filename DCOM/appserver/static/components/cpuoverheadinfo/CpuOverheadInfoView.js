define(["underscore", "jquery", "splunkjs/mvc/d3chart/d3/d3.v2.min",
	...
	"/en-US/static/app/SA-Utils/scripts/contrib/text.js!/en-US/static/app/DCOM_S/components/cpuoverheadinfo/CpuOverheadInfo.html",
	"css!./CpuOverheadInfo.css"
	], 
	function (_, $, d3, Messages, SimpleSplunkView, CpuInfoTemplate, MemInfoCSS) {
		...
		var custom_messages = {
			...
			"no-results" : {
					icon: "info-circle",
					level: "info",
					message: "Calculation in process, please be patient"
				}
			};
		 ...
		 */ 
		var compiled_template = _.template(CpuInfoTemplate);
		
		var CpuOverheadInfoView = SimpleSplunkView.extend({
			className: "cpu-overhead-info",
			/*
			...
			formatData: function(data) {
				console.log("CPU.formatData:");
				console.log(JSON.stringify(data));
				var transformed_data = {parse_error: false};
				//Get the row we care about
				var colNames = ["host", "moid","name", "actual_num_vms","p_average_clusterServices_effectivecpu_megaHertz", "num_vms", "cpu_per_vm", "num_hosts2", "additional_vms"];
