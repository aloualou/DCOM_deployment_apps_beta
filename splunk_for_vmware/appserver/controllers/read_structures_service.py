...
sys.path.append(make_splunkhome_path(['etc', 'apps', 'splunk_for_vmware', 'local', 'data']))
...
class read_structures_service(controllers.BaseController):
    ...
    def _readFilesFromFolder(self,folderName, datatype):
        ...
        """
        try:
            folderPath= make_splunkhome_path(['etc', 'apps', 'splunk_for_vmware','local', 'data', folderName])
            structDict={}
